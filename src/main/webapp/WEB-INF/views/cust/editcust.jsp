...
<div class="container">
	<form method="post" action="/cust/editcust.do" id="subform" class="form-horizontal">
		<input name="cust" type="hidden" value="${requestScope.cust.id}" />
		<div class="control-group">
			<label  class="control-label">客户姓名：</label>
			<div class="controls">
				<input name="custname" value="${requestScope.cust.custname }" placeholder="客户名" type="text"/>
			</div>
		</div>
		<div class="control-group">
			<label  class="control-label">客户职位：</label>
			<div class="controls">
				<input name="jobs" value="${requestScope.cust.jobs }" placeholder="客户职位" type="text"/>
			</div>
		</div>
		<div class="control-group">
			<label  class="control-label">所属公司：</label>
			<div class="controls">
				<input name="company" value="${requestScope.cust.company.custname }" placeholder="所属公司" type="text" />
			</div>
		</div>
		<div class="control-group">
			<label  class="control-label">tel：</label>
			<div class="controls">
				<input name="tel" value="${requestScope.cust.tel }" placeholder="tel" type="text"/>
			</div>
		</div>
		<div class="control-group">
			<label  class="control-label">email:</label>
			<div class="controls">
				<input name="email" value="${requestScope.cust.email }" placeholder="email" type="text"/>
			</div>
		</div>
		<div class="control-group">
			<label  class="control-label">address</label>
			<div class="controls">
				<input name="address" value="${requestScope.cust.address }" placeholder="address" type="text" />
			</div>
		</div>
		<div class="control-group">
